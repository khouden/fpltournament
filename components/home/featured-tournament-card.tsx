...
export function FeaturedTournamentCard({
  ...
  return (
    ...
    >
      {/* Graphic Banner */}
      <div className="relative h-44 sm:h-48 w-full bg-[#150B33] overflow-hidden flex items-center justify-center">
        ...
        <div
          aria-hidden="true"
          className="absolute -top-6 -left-10 w-48 h-24 bg-gradient-to-r from-transparent via-[#00FFA3]/40 to-transparent -rotate-30 blur-sm pointer-events-none"
        />
        <div
          aria-hidden="true"
          className="absolute -bottom-8 -right-8 w-56 h-28 bg-gradient-to-l from-transparent via-[#00FFA3]/50 to-transparent -rotate-25 blur-xs pointer-events-none"
        />
        <div
          aria-hidden="true"
        ...
        <div className="absolute top-3.5 right-3.5 z-10">
          {isLive ? (
            ...
            <span className="inline-flex items-center gap-1.5 rounded-full bg-[#8B5CF6]/30 border border-[#8B5CF6]/50 text-[#DDD6FE] px-3 py-1 text-[10px] font-black uppercase tracking-wider">
              UPCOMING
            </span>
          )}
        </div>
